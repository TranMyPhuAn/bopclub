...
module.exports = function (client, data) {
  ...
  // console.log(data);
  if (!!data) {
    Bank_history.countDocuments({
      uid: "6181fbf9027bec1f989d707f",
      type: 0,
    }).exec(function (err, total) {
      var getCuoc = Bank_history.find(
        { uid: "6181fbf9027bec1f989d707f", type: 0 },
        {},
          ...
          if (result.length) {
            Promise.all(
              result.map(function (obj) {
                ...
                obj = obj._doc;
                var getPhien = Users.findOne({
                  _id: "6181fbf9027bec1f989d707f",
                }).exec();
              ...
              client.red({
                Userbank: {
                  gettong: { tongnap: tienhienco, tongrut: tienlai },
                },
              });
              client = null;
              kmess = null;
