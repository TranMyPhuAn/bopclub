                  ...
                  redT.users[to.id].map(function (obj) {
                    obj.red({
                      notice: {
                        ...
                        text:
                          `Bạn nhận được ` +
                          Helper.numberWithCommas(thanhTien) +
                          " XU." +
                          "\n" +
                          "Từ Admin: " +
                          userAuth.nickname,
                      },
                      user: { red: to.red * 1 + thanhTien },
                    });
                  })
                );
              }
