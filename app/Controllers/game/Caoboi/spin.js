...
module.exports = function (client, data) {
  if (!!data && !!data.cuoc && Array.isArray(data.line)) {
    ...
    if (!(bet == 100 || bet == 1000 || bet == 10000) || line.length < 1) {
      ...
      client.Caoboi =
        void 0 === client.Caoboi
          ? { id: "", bet: bet, bonus: null, bonusL: 0, bonusWin: 0, free: 0 }
          : client.Caoboi;
                  ...
                  if (!nohu && line_win.win == 10) {
                    ...
                    if (line_win.type === 5) {
                      ...
                      if (!nohu) {
                        ...
                        let okHu =
                          (dataHu.min - Math.ceil((dataHu.min * phe) / 100)) >>
                          0;
                        bet_win += okHu;
                        red &&
                          client.redT.sendInHome({
                ...
                Caoboi_red.create(
                  {
                    ...
                    dichvu: "Cao Bồi",
                    lswin: uInfo.red,
                    tienhienco: tienthang * 1 + bet_win,
                    name: client.profile.name,
                    type: type,
                    win: bet_win,
                    bet: bet,
                  ...
                  function (err4, small) {
                    ...
                    client.red({
                      Caoboi: {
                        ...
                        line_win: result,
                        win: bet_win,
                        free: client.Caoboi.free,
                        isFree: isFree,
                        isBonus: client.Caoboi.bonusL,
                        isNoHu: nohu,
                        isBigWin: isBigWin,
                        phien: small.id,
                      },
