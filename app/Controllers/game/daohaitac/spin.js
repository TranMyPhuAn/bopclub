...
module.exports = function (client, data) {
  ...
  if (!!data && !!data.cuoc && Array.isArray(data.line)) {
    ...
    if (!(bet == 100 || bet == 1000 || bet == 10000) || line.length < 1) {
      client.red({
        daohaitac: { status: 0 },
        notice: { text: "DỮ LIỆU KHÔNG ĐÚNG...", title: "THẤT BẠI" },
      });
    } else {
      client.Daohaitac =
        void 0 === client.Daohaitac
          ? {
              id: "",
              red: red,
              bet: bet,
      ...
      UserInfo.findOne(
        { id: client.UID },
        red ? "red name daily" : "xu name daily",
        function (err, user) {
          if (
            client.Daohaitac.free === 0 &&
            ((red && user.red < tongCuoc) || (!red && user.xu < tongCuoc))
          ) {
            client.red({
              daohaitac: { status: 0, notice: "Bạn không đủ số dư" },
            });
          } else {
            if (user.daily != "")
              Helpers.pushDailyVIP({
                daily: user.daily,
                reason:
                  "Cộng tiền người chơi " + user.name + " chơi Đảo Hải Tặc",
                type: true,
                total: tongCuoc,
              });
            ...
            // tạo kết quả
            HU.findOne(
              { game: "daohaitac", type: bet, red: red },
              {},
              function (err2, dataHu) {
                let uInfo = {};
                let mini_users = {};
                ...
                Promise.all(
                  line.map(function (selectLine) {
                    switch (selectLine) {
                      ...
                      case 14:
                        ...
                        return check_win(
                          [cel1[0], cel2[1], cel3[0], cel4[1], cel5[0]],
                          selectLine
                        );
                        break;
                      ...
                      case 15:
                        ...
                        return check_win(
                          [cel1[2], cel2[1], cel3[2], cel4[1], cel5[2]],
                          selectLine
                        );
                        break;
                      ...
                      case 18:
                        ...
                        return check_win(
                          [cel1[0], cel2[0], cel3[2], cel4[0], cel5[0]],
                          selectLine
                        );
                        break;
                      ...
                      case 19:
                        ...
                        return check_win(
                          [cel1[2], cel2[2], cel3[0], cel4[2], cel5[2]],
                          selectLine
                        );
                        break;
                      ...
                      case 20:
                        ...
                        return check_win(
                          [cel1[0], cel2[2], cel3[2], cel4[2], cel5[0]],
                          selectLine
                        );
                        break;
                      ...
                      case 21:
                        ...
                        return check_win(
                          [cel1[2], cel2[0], cel3[0], cel4[0], cel5[2]],
                          selectLine
                        );
                        break;
                      ...
                      case 23:
                        ...
                        return check_win(
                          [cel1[1], cel2[2], cel3[0], cel4[2], cel5[1]],
                          selectLine
                        );
                        break;
                  ...
                  result = result.filter(function (line_win) {
                    ...
                    if (!nohu && line_win.win == 10) {
                      ...
                      if (line_win.type === 5) {
                        ...
                        if (!nohu) {
                          let okHu =
                            (quyHu - Math.ceil((quyHu * phe) / 100)) >> 0;
                          bet_win += okHu;
                          HU.updateOne(
                            { game: "daohaitac", type: bet, red: red },
                            { $set: { name: "", bet: dataHu.min } }
                          ).exec();
                          red &&
                      ...
                      function (err4, small) {
                        ...
                        client.red({
                          daohaitac: {
                            ...
                            line_win: result,
                            win: bet_win,
                            free: client.Daohaitac.free,
                            isFree: isFree,
                            isBonus: client.Daohaitac.bonusL,
                            isNoHu: nohu,
                            isBigWin: isBigWin,
                            phien: small.id,
                          },
                          user: { red: user.red - tongCuoc },
                        });
                      ...
                      function (err4, small) {
                        client.red({
                          daohaitac: {
                            ...
                            free: client.Daohaitac.free,
                            isFree: isFree,
                            isBonus: !!client.Daohaitac.bonusX,
                            isNoHu: nohu,
                            isBigWin: isBigWin,
                            thuong: thuong,
                            phien: small.id,
                          },
                          user: { xu: user.xu - tongCuoc },
                        });
                        client.Daohaitac.id = small._id.toString();
                      }
                    );
                  ...
                  Daohaitac_user.updateOne(
                    { uid: client.UID },
                    { $set: { time: new Date() }, $inc: mini_users }
                  ).exec();
                });
              }
            );
