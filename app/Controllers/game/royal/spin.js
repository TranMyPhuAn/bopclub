  ...
  if (!!data && !!data.cuoc && Array.isArray(data.line)) {
    ...
    if (!(bet == 100 || bet == 1000 || bet == 10000) || line.length < 1) {
      ...
      if (client.RoyAl.free > 0 && bet != client.RoyAl.lastBet) {
        client.red({
          RoyAl: { notice: "Bạn không nên đổi cược khi đang free spin" },
        });
      } else {
        ...
        UserInfo.findOne(
          ...
          function (err, user) {
            if (
              ...
              client.red({
                RoyAl: { status: 0, notice: "Bạn không đủ số dư" },
              });
            } else {
                    ...
                    if (red) {
                      ...
                      client.red({
                        royal: {
                          ...
                          line_win: result,
                          win: bet_win,
                          free: client.RoyAl.free,
                          isFree: isFree,
                          isBonus: client.RoyAl.bonusX,
                          isNoHu: nohu,
                          isBigWin: isBigWin,
                        },
