                    ...
                    function (error, create) {
                      if (!!create) {
                          ...
                          function (err, httpResponse, body) {
                            ...
                            try {
                              ...
                              client.red({
                                notice: {
                                  title: "THẤT BẠI",
                                  text: "Hệ thống đã ghi nhận thẻ của bạn. Vui lòng kiểm tra lịch sử giao dịch!",
                                  load: false,
                                },
                              });
                            }
                        ...
                        client.red({
                          notice: {
                            title: "BẢO TRÌ",
                            text: "Hệ thống nạp thẻ tạp thời không hoạt động, vui lòng giữ lại thẻ và quay lại sau.",
                            load: false,
                          },
                        });
                      }
