    ...
    Phone.findOne(
      ...
      function (err, check1) {
        if (check1) {
            ...
            telegram.create(
              ...
              function (err, cP) {
                ...
                if (!!cP) {
                  UserInfo.findOneAndUpdate(
                    ...
                    if (!!info) {
                      redT.telegram.sendMessage(
                        id,
                        "_XÁC THỰC THÀNH CÔNG_\nBạn nhận được +50000000 X Vào tài khoản *" +
                          info.name +
                          "*, chúc bạn chơi game vui vẻ...\n\n*HƯỚNG DẪN*\n\nNhập:\n*OTP*:           Lấy mã OTP miễn phí.\n*GiftCode*:  Nhận ngay 50tr Test game miễn phí ngay hôm nay.",
                        {
                          parse_mode: "markdown",
                  ...
                  redT.telegram.sendMessage(id, "_Thao tác thất bại_", {
                    parse_mode: "markdown",
                    reply_markup: { remove_keyboard: true },
                  });
                  redT = null;
          ...
          redT.telegram.sendMessage(
            id,
            "Số điện thoại này chưa được đăng ký. Vui lòng đăng ký tại BOPCLUB",
