...
Admin.estimatedDocumentCount().exec(function (err, total) {
  if (total == 0) {
    Admin.create({
      username: "admin",
      password: generateHash("zxczxc123"),
      rights: 9,
      regDate: new Date(),
    });
    Admin.create({
...
ThongBao.findOne({}, function (err, data) {
  if (!data) {
    ThongBao.create({
      thongbao1: "BOPCLUB Game xanh chín uy tín",
      active: "1",
      thongbao2:
        "Các siêu đại gia xuống tiền nhẹ tay cho các game thủ vào tiền nữa nhé !",
    });
  }
});
Hutaixiu.findOne({}, function (err, data) {
  if (!data) {
    Hutaixiu.create({
      md5key: "abc3339d42a5d25bb3cfcc994a06ea13",
      hutx: "5000000",
      ketquaphien: "[423]_{#6627-NSG7fPIieBkQ7iigewSizt}",
    });
  }
});
...
HU.findOne(
  { game: "minipoker", type: 100, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "minipoker", type: 1000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "minipoker", type: 10000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "bigbabol", type: 100, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "bigbabol", type: 1000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "bigbabol", type: 10000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "vuongquocred", type: 100, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "vuongquocred", type: 1000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "vuongquocred", type: 10000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "dongmauanhhung", type: 100, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "dongmauanhhung", type: 1000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "dongmauanhhung", type: 10000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "caothap", type: 1000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "caothap", type: 10000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "caothap", type: 50000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "caothap", type: 100000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "caothap", type: 500000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "sexandzen", type: 100, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "sexandzen", type: 1000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "sexandzen", type: 10000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
...
HU.findOne(
  { game: "Caoboi", type: 10000, red: true },
  {},
  function (err, data) {
    if (!data) {
      HU.create({
